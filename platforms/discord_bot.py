...
async def send_group_message(channel_id, message):
    try:
        ...
        if user:
            ...
            print(f"User with ID {channel_id} not found.")
    except (discord.NotFound, discord.HTTPException) as e:
                print(f"It is not a pivate chatid {channel_id} it will be forward to channel: {e}")
    finally:            
